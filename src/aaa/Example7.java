...
public class Example7 {
	private static String URI = "/Users/caetano/Documents/workspace/aaa/src/aaa/example7.csv";
	...
	public static void main(String args[]) {
		...
		try {
			List<DataFile> listOfDataFile = Files.lines(Paths.get(URI)).map(mapLineToDataFile).collect(Collectors.toList());
